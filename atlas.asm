...
:page_alloc_loop
      ...
      AND B, 0x00FF
      IFE B, 0x0000
          SET PC, page_alloc_lower
      SET B, [A]
      AND B, 0xFF00
      IFE B, 0x0000
          SET PC, page_alloc_upper
      ADD A, 1
      IFN A, mem_table_end
          SET PC, page_alloc_loop
      SET A, 0x00
...
:page_reserve
      ...
      ADD A, mem_table
      IFN B, 0
          SET PC, page_reserve_upper
      AND [A], 0xFF00
      BOR [A], 0x0001
      SET PC, page_reserve_end
...
:page_table_ptr dat 0x0000	; Pointer to the page table
